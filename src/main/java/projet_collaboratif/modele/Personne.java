...
@NamedQuery(name="Personne.findByLoginPassword", query="SELECT p FROM Personne p WHERE p.email = :email AND p.motPasse = :motPasse") 
...
//	}
	 ...
	 * @return True if other object is instance of class Personne and the key
	 *         objects are equal
	 */
