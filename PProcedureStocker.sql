...
BEGIN
	...
	VALUES
    (1,'Toto', 'Idrisse', 'Elysee', '75000', 'Paris', '0600000001', 'Idrisse01', 'Idrissse@yahoo.fr', 1, 1),
    (2,'rir', 'Lokk', 'Paris', '75015', 'Paris', '0600000001', 'sse01', 'Idris@yahoo.fr', 2, 2),
    (3,'rowrow', 'Like', 'Amiens', '80000', 'Amiens', '0600000001', 'Idrisse', 'Iiidris@yahoo.fr', 3, 3),
    (4,'Mounir', 'Idrisse', 'Lille', '59000', 'Lille', '0600000001', 'Irisse01', 'sse@yahoo.fr', 4, 4),
    (5,'Ridi', 'Idrisse', 'Valenciennes', '59300', 'Valenciennes', '0600000001', 'Idisoose01', 'risse@yahoo.fr', 5, 5);
    ...
    insert into projet (id_projet, id_formateur, id_promotion, titre, date_creation, date_fin)
        values   (1, 1, 1, 'Projet_A', '2019/03/01',  '2019/03/12'),
       			 (2, 2, 2, 'Projet_B', '2018/04/01',  '2019/08/01'),
       			 (3, 3, 3, 'Projet_C', '2012/03/01',  '2019/08/03'),
       			 (4, 4, 4, 'Projet_D', '2011/02/01',  '2019/06/28'),
        		 (5, 5, 5, 'Projet_E', '2010/09/01',  '2019/05/28');
    ...
    insert into equipe (id_equipe, id_createur, libelle, date_creation, commentaire)
        values   (1, 1, 'equipeCDI', '2019/03/01','Bienvenue'),
      		     (2, 2, 'EquipeRoto', '2018/09/01','Hello'),
       			 ...
       			 (4, 4, 'equipeTOTO', '2016/02/01','Coucou'),
       			 (5, 5, 'equipeCDI8', '2014/05/01','Bonjour');
